...
public class MainFrame {
	...
	protected Control createButtonBar(Composite parent) {
		...
		this.groupBtn = new Button(composite, SWT.CHECK);
		groupBtn.setText("是否下载组图");
		groupBtn.setLayoutData(new GridData(SWT.LEFT, SWT.CENTER, false, false));
	...
	private void startDownload() {
		...
		boolean isGroup = groupBtn.getSelection();
		...
		try {
			dialog.run(true, true, (monitor) -> {
				try {
					...
					downloader.startDownload(isGroup, monitor);
